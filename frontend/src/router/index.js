...
const routes = [
  ...
  { path: '/productos-promociones', name: 'productos-promociones', component: () => import('../views/ProductosPromocionesView.vue'), meta: { requiresAuth: true, rol: 'cliente' } },
  ...
  { path: '/alta-contrato-stepper', name: 'alta-contrato-stepper', component: () => import('../views/AltaContratoStepperView.vue'), meta: { requiresAuth: true, rol: 'admin' } },
